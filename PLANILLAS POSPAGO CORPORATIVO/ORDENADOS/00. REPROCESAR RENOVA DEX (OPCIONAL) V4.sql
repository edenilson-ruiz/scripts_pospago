...
begin
	...
	SELECT X.*	
		...
		,CASE
			...
			THEN (X.RENTA_MENSUAL_ACT + X.CARGOS_AVI_ACT)* CASE 																						
															WHEN CASE 
															...
															ELSE CASE 
																 ...
																 END 
														  END
		    WHEN X.PERIODO = '201807' AND X.CUSTOMER_ID IN (9717533,9888092) THEN (X.RENTA_MENSUAL_ACT + X.CARGOS_AVI_ACT) * CASE 																						
																																WHEN CASE 
																																		WHEN X.PERIODO <  '201803' THEN X.CANT_VENTAS / X.META_LLAVE
																																		WHEN X.PERIODO >= '201803' THEN X.TOTAL_REVENUE_VENTA / X.META_LLAVE
																																	 END > 1 THEN 1 
																																ELSE CASE 
																																	 ...
																																	 END 
																															  END
		    WHEN X.NOMBRE_PLAN_ACT LIKE '%CTL%APORT%2.5%' THEN ( X.RENTA_MENSUAL_ACT * 1 ) * CASE 																						
																								WHEN CASE 
																										WHEN X.PERIODO <  '201803' THEN X.CANT_VENTAS / X.META_LLAVE
																										WHEN X.PERIODO >= '201803' THEN X.TOTAL_REVENUE_VENTA / X.META_LLAVE
																									 END > 1 THEN 1 
