...
if @acreedor_id = ''
 begin
	...
	SELECT Z.*
		...
		,ISNULL(A.COSTO,0) * PCT_DESCUENTO_EQUIPO * PCT_DESCUENTO_COMISION_EFECT MONTO_CHARGEBACK
		,COMISION_POR_VENTA_SIVA * PCT_DESCUENTO_COMISION * PCT_DESCUENTO_COMISION_EFECT + 
		 ISNULL(A.COSTO,0) * PCT_DESCUENTO_EQUIPO * PCT_DESCUENTO_COMISION_EFECT MONTO
		,CASE
