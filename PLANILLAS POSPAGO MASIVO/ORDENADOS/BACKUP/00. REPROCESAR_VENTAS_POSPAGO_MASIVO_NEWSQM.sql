	...
	set @distribuidor = 'CELCOM'
		...
		begin		
			...
			DELETE FROM PagoPospagoVentasDEXMasivo WHERE PERIODO = @periodo AND DISTRIBUIDOR = @distribuidor;
			DELETE FROM PagoPospagoVentasDEXMasivo WHERE PERIODO = @PeriodoPagoYListo and TIPO IN ('Pago y Listo') and DISTRIBUIDOR = @distribuidor;
...
--SELECT CO_ID FROM PagoPospagoVentasDEXMasivo where PERIODO_PAGO = '201906' and DISTRIBUIDOR like '%COMSERTEL%'