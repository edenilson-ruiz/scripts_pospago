--DECLARAMOS LAS VARIABLES
	...
	set @distribuidor = 'CELCOM'
		...
		begin
			...
			DELETE FROM PagoPospagoVentasDEXMasivo WHERE PERIODO = @periodo AND DISTRIBUIDOR = @distribuidor and CO_ID  in ('13896877','13884257');
			DELETE FROM PagoPospagoVentasDEXMasivo WHERE PERIODO = @PeriodoPagoYListo and TIPO IN ('Pago y Listo') and DISTRIBUIDOR = @distribuidor and CO_ID  in ('13896877','13884257');
			...
			WHERE B.CANAL = 'DISTRIBUIDORES'
				...
				AND A.VENTA = 'S'
				and a.CO_ID  in ('13896877','13884257')
				...
				--AND A.CO_ID IN ('13477613','13499387')
		...
		--SELECT * FROM PagoPospagoVentasDEXMasivo where PERIODO_PAGO = '201812' and DISTRIBUIDOR like '%TDM%' --98 VENTAS se quitaran 4 para tdm que mencionó que no son de ellos		
