--DECLARAMOS LAS VARIABLES
	...
	set @distribuidor = ''
		...
		begin
			...
			DELETE FROM PagoPospagoVentasDEXMasivoSM WHERE PERIODO = @periodo;
			DELETE FROM PagoPospagoVentasDEXMasivoSM WHERE PERIODO = @PeriodoPagoYListo and TIPO IN ('Pago y Listo');
		
			--PRINT N'Se han borrado los registros del periodo = ' + @periodo;
			
			INSERT INTO PagoPospagoVentasDEXMasivoSM
			SELECT 
				X.*
				,'SI' APLICA_PAGO
				,CASE
