	...
	set @periodo = '201909'
		...
		begin
			...
			DELETE FROM PagoPospagoVentasDEXMasivo 
			WHERE CANAL = 'DISTRIBUIDORES'
				AND PERIODO = @PeriodoPagoProrrateados												
				AND ( PLAZO_NUM < 3 or PLAZO_NUM is null)
				AND PERIODO_PAGO = @PeriodoPago								
			...
			WHERE B.CANAL = 'DISTRIBUIDORES'
				...
				AND NOT EXISTS (SELECT * FROM PagoPospagoVentasDEXMasivo where PERIODO_PAGO = @PeriodoPago and CO_ID = a.co_id and COMISION > 0)
...
/*		
select PERIODO_PAGO, PERIODO, COUNT(*) Q, SUM(COMISION_SIN_IVA) M 
from PagoPospagoVentasDEXMasivo 
WHERE PERIODO_PAGO = '201909'
GROUP BY PERIODO_PAGO, PERIODO

select PERIODO_PAGO, COUNT(*) Q, SUM(COMISION_SIN_IVA) M 
from PagoPospagoVentasDEXMasivoSM
GROUP BY PERIODO_PAGO

*/
--Q	M
--1502	42832.366814159



--select * FROM PagoPospagoVentasDEXMasivo WHERE DISTRIBUIDOR LIKE '%siman%'
--select * from FactPospagoVentas where CO_ID = '13919962'
