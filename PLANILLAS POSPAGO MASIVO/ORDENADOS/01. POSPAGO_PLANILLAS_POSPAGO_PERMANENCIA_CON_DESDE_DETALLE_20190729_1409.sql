...
03/07/2019 15:52 Se cambio condición en case, donde valida si aplica o no la permanencia, se valida el estado
26/09/2019 17:08 Se adicionó permanencia 6 
=====================================================================================================================================================*/
...
--select SUM(comision_sin_iva) comision from DM_COMISV_POSPAGO.dbo.PagoPospagoPermanenciaDEXMasivo where PERIODO_PAGO = '201912'
...
--select periodo_pago, transaccion, sum(comision_sin_iva) comi from DM_COMISV_POSPAGO.dbo.PagoPospagoPermanenciaDEXMasivo where PERIODO_PAGO >= '201901' group by periodo_pago, transaccion
*/
