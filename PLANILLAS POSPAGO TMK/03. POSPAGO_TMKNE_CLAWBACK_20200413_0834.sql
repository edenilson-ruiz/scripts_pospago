...
if @acreedor_id = ''
 begin
	...
	DELETE DM_COMISV_POSPAGO.dbo.ClawbackPospagoTMKNE WHERE PERIODO_PAGO = @periodo_pago
	
	--DROP TABLE DM_COMISV_POSPAGO.dbo.ClawbackPospagoTMKNE

	--CONSTRUYENDO VENTAS POSPAGO MASIVO	
	INSERT INTO DM_COMISV_POSPAGO.dbo.ClawbackPospagoTMKNE
	...
	FROM (
		SELECT 
			...
			,getdate() FECHA_PROCESO --INTO ClawbackPospagoTMKNE
		FROM (
			SELECT 
 ...
 begin
	...
	DELETE DM_COMISV_POSPAGO.dbo.ClawbackPospagoTMKNE WHERE PERIODO_PAGO = @periodo_pago and ACREEDOR_ID = @acreedor_id
